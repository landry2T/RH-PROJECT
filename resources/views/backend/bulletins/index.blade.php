...
<main class="app-content">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-body">
          <h3><i class="bi bi-clipboard-fill"></i>IMPRIMER BULLETIN DE PAIE</h3>
         ...
         <form method="POST" action="{{route('bulletins.store')}}">
          ...
          <label>Selectionner la couleur du bulletin:*</label>
          <input type="color" name="couleur" class="form-control" min="1"><br>
          <div class="row">
            <div class="col-md-12">
              <input type="checkbox" name="" class="form-check-input" checked="on"> <label class="form-check-label">&nbsp; ajouter les informations de paie (heure supp , avance salariale , retard , etc)</label>
            </div>
          </div>
