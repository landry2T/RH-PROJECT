...
<main class="app-content">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-body">
          <h3><i class="bi bi-pencil"></i> Ajouter une catégorie document</h3>
          ...
          @endif
          <form method="POST" action="{{route('typedocs.store')}}">
            @csrf
            <label>Nom catégorie document:*</label>
            <input type="text" name="name" class="form-control"><br>
            <button type="submit" class="btn btn-primary"><i class="bi bi-pencil"></i> Ajouter Catégorie</button>
