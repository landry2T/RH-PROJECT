...
<main class="app-content">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-body">
          <h3><i class="bi bi-clipboard-check"></i> AJOUTER AVANCE SALARIALE</h3>
         ...
         <form method="POST" action="{{route('avances.store')}}">
          ...
          <label>Montant:*</label>
          <input type="number" name="montant" class="form-control" min="10">

          <br>
          <button type="submit" class="btn btn-success btn-md"><i class="bi bi-pencil"></i> Ajouter avance</button>
