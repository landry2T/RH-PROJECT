...
<main class="app-content">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-body">
          <h3><i class="bi bi-pencil"></i> AJOUTER UN DEPARTEMENT</h3>
          ...
          <form method="POST" action="{{route('departements.store')}}">
            @csrf
            <label>Nom un département:*</label>
            <input type="text" name="name" class="form-control"><br>
            <button type="submit" class="btn btn-primary"><i class="bi bi-pencil"></i> Ajouter Departement</button>
